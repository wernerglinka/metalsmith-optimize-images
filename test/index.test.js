...
describe('metalsmith-optimize-images', () => {
  ...
  it('should process images and replace with picture elements', (_t, done) => {
    metalsmith
      .use(
        optimizeImages({
          widths: [300, 600],
  ...
  it('should generate correct HTML structure for progressive loading', (_t, done) => {
  ...
  it('should skip images with data-no-responsive attribute', (_t, done) => {
    metalsmith
      .use(
        optimizeImages({
          widths: [300, 600],
  ...
  it('should skip external images and data URLs', (_t, done) => {
  ...
  it('should preserve sizes attribute from the original img', (_t, done) => {
  ...
  it('should generate metadata file when configured', (_t, done) => {
    metalsmith
      .use(
        optimizeImages({
          widths: [300, 600],
  ...
  it('should add width and height attributes when configured', (_t, done) => {
    metalsmith
      .use(
        optimizeImages({
          widths: [300, 600],
  ...
  it('should add lazy loading when configured', (_t, done) => {
    metalsmith
      .use(
        optimizeImages({
          widths: [300, 600],
  ...
  it('should preserve other attributes when replacing img elements', (_t, done) => {
    metalsmith
      .use(
        optimizeImages({
          widths: [300, 600],
  ...
  it('should handle various plugin configurations', (_t, done) => {
    metalsmith
      .use(
        optimizeImages({
          // Custom settings
  ...
  it('should handle errors in image processing gracefully', (_t, done) => {
  ...
  it('should handle errors in the main plugin function', (_t, done) => {

...
describe('Coverage gap tests - targeting missing lines', () => {
  ...
  describe('Main plugin function edge cases', () => {
    it('should handle when no HTML files are found', (_t, done) => {
    ...
    it('should handle custom HTML patterns that match no files', (_t, done) => {
  ...
  describe('Progressive image processing edge cases', () => {
    it('should handle cached progressive images', (_t, done) => {
      const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);
  ...
  describe('File system edge cases', () => {
    it('should handle images that exist in build directory but not in files', (_t, done) => {
    ...
    it('should handle missing images gracefully', (_t, done) => {
      // Use real Metalsmith instance
      const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);
  ...
  describe('Error handling paths', () => {
    it('should handle Sharp processing errors gracefully', (_t, done) => {
      // Use real Metalsmith instance
      const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);
    ...
    it('should handle metalsmith.destination errors', (_t, done) => {
    ...
    it('should handle file system errors when loading images', (_t, done) => {
  ...
  describe('Configuration edge cases', () => {
    it('should handle empty formats array', (_t, done) => {
      const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);
    ...
    it('should handle empty widths array', (_t, done) => {
      const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);

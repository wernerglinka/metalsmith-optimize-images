...
describe('Background Image Processing', () => {
  ...
  it('should process unused images for background use', (_t, done) => {
  ...
  it('should skip background processing when disabled', (_t, done) => {
    const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);
  ...
  it('should not reprocess images already used in HTML', (_t, done) => {
    const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);
  ...
  it('should handle background image processing errors gracefully', (_t, done) => {
    const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);

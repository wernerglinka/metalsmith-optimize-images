...
describe('Realistic workflow integration tests', () => {
  ...
  describe('Complete image processing workflow', () => {
    it('should process all image formats and sizes correctly', (_t, done) => {
    ...
    it('should handle progressive loading with real images', (_t, done) => {
      const metalsmith = Metalsmith(fixturesDir).clean(true).source('src').destination(buildDir);
